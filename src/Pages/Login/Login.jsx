...
const Login = () => {
  ...
  useEffect(() => {
    ...
    google.accounts.id.initialize({
      client_id:
        "590992019533-vg4un67h63tn57dvcldeb69oovkp715r.apps.googleusercontent.com",
  ...
  return (
    <div className="cover">
        ...
        <form className="login" onSubmit={handleSubmit}>
            ...
            <input value={verify} onChange={(e) => setVerify(e.target.value)} id="verify" name="verify" type="number" placeholder="Verification code"/>
